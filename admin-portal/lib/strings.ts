export const mr = {
  ...
  home: {
    ...
    subtitle:
      "गट संरचना, सदस्य यादी (CSV आधारित), आणि सेवा क्रिया (पोल, रिमाइंडर, घोषणा) एकाच ठिकाणाहून व्यवस्थापित करा.",
    openDashboard: "डॅशबोर्ड उघडा",
    cards: {
      operateSevas: {
        title: "सेवा संचालन",
        description: "पोल + संदेश, रिमाइंडर्स (स्वयंचलित/निवडक), आणि गट घोषणा सुरू करा."
      },
      manageGroups: {
        title: "गट व्यवस्थापन",
  ...
  groupMembers: {
    ...
    placeholders: {
      ...
      phoneOptional: "ऐच्छिक फोन (रिमाइंडरसाठी)"
    },
    remove: "काढा",
